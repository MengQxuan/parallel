...
void sse_openmp(float *A, float *b, float *x, int n, int num_threads)
{
...
int main()
{
    ...
    auto start = chrono::high_resolution_clock::now();
    sse_openmp(A, b, x, n, num_threads);
    auto end = chrono::high_resolution_clock::now();

    cout << "SSE+OpenMP用时: " << chrono::duration_cast<chrono::microseconds>(end - start).count() << " us" << endl;
